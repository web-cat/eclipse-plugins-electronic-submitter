...
public class TargetRoot extends AbstractTarget implements ITargetRoot
{
	...
	public void fireTargetChanged(ITargetChangedEvent event)
	{
		for(int i = 0; i < changeListeners.size(); i++)
		{
			ITargetChangedListener listener =
				(ITargetChangedListener)changeListeners.get(i);
			listener.targetChanged(event);
		}
	}

	public void fireTargetObjectChanged(ITarget object, String property, Object oldValue, Object newValue)
	{
		TargetChangedEvent event = new TargetChangedEvent(this, object, property, oldValue, newValue);
	...
	public void writeToXML(PrintWriter writer, int indentLevel)
	{
		...
		writer.println("<submission-targets xmlns=\"http://web-cat.cs.vt.edu/submissionTargets\">");
