...
{
	/**
	 * Returns the object that represents the root of the submission target
	 * tree.
	 * 
	 * @return An IDefinitionObject that represents the root of the submission
	 *         target tree.
	 */
	ITargetRoot getRoot();
	 ...
	 * @param params
	 *            A SubmissionParameters object that describes the project to
	 *            be submitted.
	 * 
