...
public class SWTUtil
{
	...
	// ------------------------------------------------------------------------
	/**
	 * Returns an estimate of the height in pixels of a table with the specified
	 * number of rows.
	 * 
	 * @param table
	 *            the Table whose height should be calculated
	 * 
	 * @param rows
	 *            the number of rows that should be used to estimate the height
	 *            of the table
	 * 
